...
const SUPPORTED_ROLES = new Set<NormalizedMessage["role"]>([
  "system",
  "developer",
  "user",
  "assistant"
]);
const TEXT_BLOCK_TYPES = new Set<MessageTextBlock["type"]>([
  "text",
  "input_text",
  "output_text"
]);

export function normalizeConversationInput(input: ConversationInput): NormalizedConversationInput {
...
export function normalizeText(value: string, label: string): string {
...
export function normalizeMessageEntries(
  ...
  defaultRole?: NormalizedMessage["role"]
): NormalizedMessage[] {
...
export function normalizeMessage(
  ...
  defaultRole: NormalizedMessage["role"] | undefined,
  index: number
): NormalizedMessage {
...
export function normalizeMessageContent(content: string | MessageTextBlock[], label: string): string {
